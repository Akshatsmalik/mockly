...
export function HeroPromoPage() {
  ...
  const {sessions,setSessions} = useContext(Data)
        ...
        >
          ...
          <motion.div variants={slideUpVariants} className="mb-6">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-brand-50 text-brand-600 rounded-full text-sm font-medium">
              A Mock Interview Before your interview
            </span>
          </motion.div>
          ...
          {/* Trust badges */}
          <motion.div variants={slideUpVariants} className="mt-12 flex flex-col items-center justify-center gap-[120px] text-sm text-muted">
            ...
            <footer className="border-t border-gray-100 py-12 mt-[150px]">
            <div className="max-w-6xl mx-auto flex items-center justify-between">
              <div className="flex items-center gap-3">
                <MocklyLogo />
                <span className="font-semibold text-gray-900">Mockly.AI</span>
              </div>
              <p className="text-sm text-muted">© 2025 Mockly. All rights reserved.
              </p>
            </div>
          </footer>
...
function DecorativeCard1() {
  return (
    <motion.div
      ...
      className="w-100 h-[100px] bg-amber-100 rounded-xl p-4 shadow-card transform -rotate-6"
    >
...
function DecorativeCard2() {
  return (
    <motion.div
      ...
      className="w-[200px] h-[150px] bg-green-200 rounded-xl p-4 shadow-card transform rotate-6 flex flex-col items-center justify-center"
    >
      <div className="flex items-center gap-2 mb-2">
        <CheckCircle className="w-5 h-5 text-green-500" />
        <span className="font-medium text-gray-800 text-md">Interview Passed!</span>
      </div>
      <p className="text-lg text-gray-600">Score: 9.2/10</p>
    </motion.div>
  )
}
...
function DecorativeCard3() {
  return (
    <motion.div
      ...
      className="w-[320px] bg-blue-200 rounded-xl p-10 shadow-card flex flex-col"
    >
      <p className="text-lg text-blue-800 font-medium mb-3">Progress This Week</p>
      ...
      <p className="text-right text-sm text-blue-600 mt-2">+75%</p>
    </motion.div>
  )
}
...
function DecorativeCard4() {
  return (
    <motion.div
      ...
      className="w-[220] bg-purple-200 rounded-xl p-10 shadow-card"
    >
      <p className="text-xl text-purple-600 font-medium mb-2">Sessions Completed</p>
